...
INSERT INTO `membre` (`id_membre`, `pseudo`, `mdp`, `nom`, `prenom`, `email`, `sexe`, `ville`, `cp`, `adresse`,
                      `statut`)
VALUES (1, 'admin', 'admin', 'basquin', 'julien', 'julienbasquin@hotmail.com', 'm', 'PARIS', 75,
        '70 rue de tocqueville', 1),
...
INSERT INTO `produit` (`id_produit`, `date_arrivee`, `date_depart`, `prix`, `etat`, `id_salle`, `id_promotion`)
VALUES (1, '2014-10-01 09:00:00', '2014-10-04 18:00:00', 300, 0, 1, NULL),
...
INSERT INTO `promotion` (`id_promotion`, `code_promo`, `reduction`)
VALUES (1, 'lo456k', 100),
       (2, 'lo123k', 100),
       (3, 'lo654k', 75);
...
INSERT INTO `salle` (`id_salle`, `pays`, `ville`, `adresse`, `cp`, `titre`, `description`, `photo`, `capacite`,
                     `categorie`)
VALUES (1, 'France', 'Paris', '10 rue Adresse', '75', 'Salle Duval', 'description', 'img/salle1.jpg', 50, 'reunion'),
       ...
       (6, 'France', 'Marseille', '10 rue Adresse', '13', 'Salle Victoire', 'description', 'img/salle6.jpg', 30,
        'reunion'),
       ...
       (9, 'France', 'Marseille', '10 rue Adresse', '13', 'Salle carriere', 'description', 'img/salle9.jpg', 10,
        'reunion'),
       (10, 'France', 'Lyon', '10 rue Adresse', '69', 'Salle Cezanne', 'description', 'img/salle10.jpg', 30, 'reunion'),
       (11, 'France', 'Paris', '10 rue Adresse', '75', 'Salle Clesinger', 'description', 'img/salle11.jpg', 45,
        'reunion'),
       (12, 'France', 'Marseille', '10 rue Adresse', '13', 'Salle Couture', 'description', 'img/salle12.jpg', 20,
        'reunion'),
       (13, 'France', 'Paris', '10 rue Adresse', '75', 'Salle Daubigny', 'description', 'img/salle13.jpg', 30,
        'reunion'),
       (14, 'France', 'Lyon', '10 rue Adresse', '69', 'Salle Delacroix', 'description', 'img/salle14.jpg', 20,
        'reunion'),
       (15, 'France', 'Paris', '10 rue Adresse', '75', 'Salle Delaroche', 'description', 'img/salle15.jpg', 20,
        'reunion'),
       (16, 'France', 'Marseille', '10 rue Adresse', '13', 'Salle Demanche', 'description', 'img/salle16.jpg', 35,
        'reunion'),
       (17, 'France', 'Lyon', '10 rue Adresse', '69', 'Salle Latour', 'description', 'img/salle17.jpg', 20, 'reunion'),
       (18, 'France', 'Paris', '10 rue Adresse', '75', 'Salle Jouvenet', 'description', 'img/salle18.jpg', 60,
        'reunion'),
       (19, 'France', 'Lyon', '10 rue Adresse', '69', 'Salle Grimaud', 'description', 'img/salle19.jpg', 65, 'reunion'),
       (20, 'France', 'Paris', '10 rue Adresse', '75', 'Salle Langlois', 'description', 'img/salle20.jpg', 30,
        'reunion');
