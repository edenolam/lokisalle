		...
		<?php foreach($produits as $produit) : ?>
			<li>
				...
				<div class="produit_info">
					...
					<div class="lien">
					<a href="<?php echo RACINE_SITE; ?>details_reservation.php?id_produit=<?php echo $produit['id_produit'];?>">Voir la fiche détaillé</a> |
			
					<?php if(connecte()): ?>
						<a href="<?php echo RACINE_SITE; ?>panier.php?id_produit=<?php echo $produit['id_produit'];?>">Ajouter au panier</a>
					<?php else: ?>
					    <a href="<?php echo RACINE_SITE; ?>connexion.php?id_produit=<?php echo $produit['id_produit'];?>">Connectez vous pour ajouter au panier</a>
					<?php endif; ?>
					<div>
						<br />
						<br />
