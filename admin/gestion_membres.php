...
if (isset($_POST['valider'])) {
    ...
    if (empty($msg)) {
        ...
        if ($membre->num_rows > 0) {
            ...
            execute_requete("INSERT INTO membre (pseudo, mdp, nom, prenom, email, ville, sexe, cp, adresse, statut )  
    ...
    <div id="creadmin">
        <form method="post" action="">
            ...
            <input type="text" name="pseudo" id="pseudo"
                   value="<?php if (isset($_POST['pseudo'])) echo $_POST['pseudo']; ?>"/><br/>
            ...
            <input type="radio" name="sexe"
                   value="m" <?php if (isset($_POST['sexe']) && $_POST['sexe'] == "m") echo "checked";
            elseif (!isset($_POST['sexe'])) echo "checked"; ?> />

            <label for="sexe">Femme</label>
            <input type="radio" name="sexe"
                   value="f" <?php if (isset($_POST['sexe']) && $_POST['sexe'] == "f") echo "checked"; ?>/>
            <br/>
            ...
            <textarea name="adresse"
                      id="adresse"><?php if (isset($_POST['adresse'])) echo $_POST['adresse']; ?></textarea><br/>
