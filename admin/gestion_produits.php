...
<form method="post" action="" >
	...
	<input type="text" name="date_arrivee" id="date_arrivee" value="<?php if(isset($_POST['date_arrivee'])) echo $_POST['date_arrivee']; ?>" placeholder=" jj-mm-AAAA "/>

	<label for="date_depart">depart</label>
	<input type="text" name="date_depart" id="date_depart" value="<?php if(isset($_POST['date_depart'])) echo $_POST['date_depart']; ?>" placeholder="jj-mm-AAAA"/>

	<label for="prix">prix</label>
	<input type="text" name="prix" id="prix" value="<?php if(isset($_POST['prix'])) echo $_POST['prix']; ?>" placeholder="ex: 1000€"/>
