...
<form method="post" action="" enctype="multipart/form-data">
     <input type="hidden" name="id_salle" value="<?php if(isset($_POST['id_salle'])) echo $_POST['id_salle']; ?>" />
		...
		<input type="text" name="latitude" id="latitude" value="<?php if(isset($_POST['latitude'])) echo $_POST['latitude']; ?>"/>

	
	    <label for="longitude">longitude</label>
		<input type="text" name="longitude" id="longitude" value="<?php if(isset($_POST['longitude'])) echo $_POST['longitude']; ?>"/>
...
?> 
	<label for="capacite">Capacite</label>
		<input type="text" name="capacite" id="capacite" value="<?php if(isset($_POST['capacite'])) echo $_POST['capacite']; ?>" />
		<br />
