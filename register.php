...
?>
		<div id="abo_news">
			...
			<hr style="background-color: #c4c4c4; width: 400px;"><h2>NEWSLETTER</h2><hr style="background-color: #c4c4c4; width: 400px;">
			...
			<?php else : ?>
				...
				<p>Vous devez vous <a style="color:red;" href="connexion.php?action=register">connecter</a> ou <a style="color:red;" href="inscription.php?action=register">créer un compte</a> afin de vous abonné à la newsletter</p>
				</div>
			<?php endif; ?>
		</div>
