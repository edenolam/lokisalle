...
<div id="descript_detail_salle">
    <div class="detail_salle">
        ...
        <img style="width:300px; height:200px;" src="<?php echo $detail['photo']; ?>"
             alt="<?php echo $detail['titre']; ?>">
    </div>
    ...
    <div class="description_detail">
        ...
        <?php else: ?>
            <p><a href="connexion.php?id_produit=<?php echo $detail['id_produit']; ?>">Connectez vous</a> pour ajouter
                au panier</p>
        <?php endif; ?>
    </div>
</div>
    ...
    <div class="avis_soumis">
        <?php if (isset($liste_avis[1])) :
            foreach ($liste_avis as $avis) :
                ...
                <div class="avis">
                    <p><span><?php echo ucfirst($avis['prenom']); ?></span>, le
                        <span><?php echo $jour . " " . $mois . " " . $annee . " a " . $heure . "h" . $minute; ?></span>
                    </p>
        ...
        elseif (!empty($liste_avis)) :
            ...
            <div class="avis">
                <p><span><?php echo ucfirst($liste_avis['prenom']); ?></span>, le
                    <span><?php echo $jour . " " . $mois . " " . $annee . " a " . $heure . "h" . $minute; ?></span></p>
                <p><?php echo $liste_avis['commentaire']; ?></p><span
                        class="note"><?php echo $liste_avis['note']; ?>/10</span>
                <hr color=#333333 width=350>
            </div>
        <?php else : ?>
