...
<div class="recherche">
    <div class="recherchedate">
        ...
        <form method="post" action="" enctype="">
            ...
            <input type="text" name="date_rech" id="date_rech" placeholder=" jj-mm-AAAA "
                   value="<?php if (isset($_POST['date_valide'])) echo $_POST['date_rech']; ?>">
    ...
    <div class="rechercheville">
        <form method="post" action="" enctype="">
            ...
            <input type="text" name="long_rech" id="long_rech" placeholder="Paris, Lyon, Marseille."
                   value="<?php if (isset($_POST['eval_rech'])) {
                       echo $_POST['long_rech'];
                   } ?>">
